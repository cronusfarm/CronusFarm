#!/bin/bash
# [부트스트랩] ~/CronusFarm/scripts/pi-repair-upcode.sh 가 없을 때 사용.
# Thalia:  scp scripts/pi-bootstrap-upcode.sh dooly@ida:~
# ida:     bash ~/pi-bootstrap-upcode.sh
# (내용은 pi-paste-on-ida.sh 와 동일 — 수정 시 두 파일 함께 맞출 것)
set -euo pipefail
